...
/*IN USE */void TIM_DeInit(TIM_TypeDef* TIMx);

/*IN USE */void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct);

/*IN USE */void TIM_TimeBaseStructInit(TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct);

void TIM_PrescalerConfig(TIM_TypeDef* TIMx, uint16_t Prescaler, uint16_t TIM_PSCReloadMode);

/*IN USE */void TIM_CounterModeConfig(TIM_TypeDef* TIMx, uint16_t TIM_CounterMode);

/*IN USE */ void TIM_SetCounter(TIM_TypeDef* TIMx, uint32_t Counter);

void TIM_SetAutoreload(TIM_TypeDef* TIMx, uint32_t Autoreload);

/*IN USE */ uint32_t TIM_GetCounter(TIM_TypeDef* TIMx);
...
/*IN USE */void TIM_Cmd(TIM_TypeDef* TIMx, FunctionalState NewState);
...
/*IN USE */void TIM_ETRClockMode1Config(TIM_TypeDef* TIMx, uint16_t TIM_ExtTRGPrescaler, uint16_t TIM_ExtTRGPolarity,
